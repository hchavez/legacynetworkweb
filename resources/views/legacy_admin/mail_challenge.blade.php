...
@section('content')
    <div class="panel panel-headline">
        <div class="panel-heading">
            <h3 class="panel-title">User Mail Challenge</h3>
    ...
    <script>
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ url('legacy_admin/dt/mail_challenge') }}',
                    data: function(d) {
...
//                    var data = table.row(this).data();
                    ...
                    swal({
                        ...
                        if (result.value) {
                            $.ajax({
                                ...
                                url: '/legacy_admin/legacy/challenge/' + distributorId,
        ...
        function format ( d ) {
            ...
            var url = '{{ url('legacy_admin/legacy/mail_challenge/') }}' + '/';
            return '<table class="table">' +
                        ...
                        '<tr>' + 
                            ...
                            '<td>' +
                                '<a href="{{ url('legacy_admin/legacy/mail_challenge/') }}' + '/' + d.id + '/edit' + '" class="btn btn-sm btn-primary">Mail Challenge Now!</a> ' +
