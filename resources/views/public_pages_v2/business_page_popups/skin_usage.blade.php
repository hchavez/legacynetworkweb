<div class="transparent-pop-up">
    <div style="margin-top: 50px;">
        <header style="height: 100%">
            <iframe src="https://player.vimeo.com/video/447631821" width="100%" height="450" frameborder="0"
                    allow="autoplay; fullscreen" allowfullscreen></iframe>
        </header>
    </div>
    <div class='white-pop-up' style="margin-top: 18px;">
        <div class='pop-up-content'>
            <h3 class='heading'>USING TRULUM IS SIMPLE!</h3>

            <p>
            	Each product in <a target="_blank" href="{{ asset('/files/Trulum_guide_en_us_0318.pdf') }}">Trulūm's exclusive product line</a> is designed to work synergistically to maximise benefits. To achieve outstanding results with Trulūm, simply follow our  <a target="_blank" href="{{ asset('/files/Trulum catalog and Usage.pdf') }}">product usage steps </a>
            	which include:
