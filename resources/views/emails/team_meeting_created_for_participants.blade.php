                ...
                <tr>
                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                            ...
                            <br>
                            <br>
                            {{ $creator->full_name }} has scheduled your next
                            Team meeting and is happy you will participate.
                            <br>
                            <br>
                            Please join {{ $creator->full_name }}  and the rest of your
                            Team on {{ $meeting->meeting_date->format('m-D-Y') }} {{ $meeting->meeting_time }}.
                            <br>
                            <br>
