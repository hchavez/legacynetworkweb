...
@section('content')
    <section class="main-content container">
        <h1>Legacy Network Terms of Use <br>(Effective as of January 1, 2018)</h1>

        <p>Welcome to the Legacy Network’s Terms of Use agreement. For purposes of this agreement, “Site” refers to the Company’s website, which can be accessed at Legacynetwork.com or through our mobile application. “Service” refers to the Company’s services accessed via the Site, in which users can login and access the Legacy Network dashboard.  This dashboard has a variety of services including but not limited to, training tools, sales tools, team management tools, and achievements. The terms “we,” “us,” and “our” refer to the Company. “You” refers to you, as a user of our Site or our Service.</p>
        <p>The following Terms of Use apply when you view or use the Service via our website located at Legacynetwork.com or by accessing the Service through clicking on the application (the “App”) on your mobile device.</p>
        <p>Please review the following terms carefully. By accessing or using the Service, you signify your agreement to these Terms of Use. <strong>If you do not agree to be bound by these Terms of Use in their entirety, you may not access or use the Service.</strong></p>

        <h2>PRIVACY POLICY</h2>
        <p>The Company respects the privacy of its Service users. Please refer to the Company’s Privacy Policy (found here: Legacynetwork.com/privacypolicy) which explains how we collect, use, and disclose information that pertains to your privacy. When you access or use the Service, you signify your agreement to the Privacy Policy as well as these Terms of Use.</p>

        <h2>ABOUT THE SERVICE</h2>
        <p>The Service allows you to access the Legacy Network dashboard.  The Dashboard has multiple tools,  all of which are designed to help our members build a successful business.  There are many tools including but not limited to meeting tools, team viewer tools, achievement tools, personal goal management tools, and training tools.</p>

        <h2>REGISTRATION; RULES FOR USER CONDUCT AND USE OF THE SERVICE</h2>
        <p>You need to be at least 18 years old and a resident of the United States to register for and use the Service.</p>
        ...
        <p>When you create your own personalized account, you may be able to provide personal and payment info, as well as authorization for charges to use Legacy Network dashboard (“User Content”) to the Service. You are solely responsible for the User Content that you post, upload, link to or otherwise make available via the Service.</p>
        ...
        <p>Though we strive to enforce these Terms of Use, you may be exposed to User Content that is inaccurate or objectionable when you use or access the Site or the Service. We reserve the right, but have no obligation, to monitor the materials posted in the public areas of the Site or the Service or to limit or deny a user’s access to the Service or take other appropriate action if a user violates these Terms of Use or engages in any activity that violates the rights of any person or entity or which we deem unlawful, offensive, abusive, harmful or malicious. E-mails sent between you and other participants that are not readily accessible to the general public will be treated by us as private to the extent required by applicable law, but will be shared with Synergy Worldwide. The Company shall have the right to remove any material that in its sole opinion violates, or is alleged to violate, the law or this agreement or which might be offensive, or that might violate the rights, harm, or threaten the safety of users or others.  Unauthorized use may result in criminal and/or civil prosecution under Federal, State and local law. If you become aware of a misuse of our Service or violation of these Terms of Use, please contact us support@legacynetwork.com.</p>
        ...
        <ul>
            ...
            <li>Your name, address, telephone number, and email address, a statement that you consent to the jurisdiction of the federal court in UTAH and a statement that you will accept service of process from the person who provided notification of the alleged infringement.</li>
        </ul>
        ...
        <p>We may also use your email address to send you other messages, including information about the Site or the Service and special offers. You may opt out of such email by changing your account settings, using the “Unsubscribe” link in the message, or by sending an email to support@legacynetwork.com or mail to the following postal address:</p>
        ...
        <p>These Terms of Use and your use of the Site are governed by the federal laws of the United States of America and the laws of the State of Utah, without regard to conflict of law provisions.</p>
        ...
        <p>YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF USE, UNDERSTAND THE TERMS OF USE, AND WILL BE BOUND BY THESE TERMS AND CONDITIONS. YOU FURTHER ACKNOWLEDGE THAT THESE TERMS OF USE TOGETHER WITH THE PRIVACY POLICY AT LEGACYNETWORK.COM/PRIVACY REPRESENT THE COMPLETE AND EXCLUSIVE STATEMENT OF THE AGREEMENT BETWEEN US AND THAT IT SUPERSEDES ANY PROPOSAL OR PRIOR AGREEMENT ORAL OR WRITTEN, AND ANY OTHER COMMUNICATIONS BETWEEN US RELATING TO THE SUBJECT MATTER OF THIS AGREEMENT.</p>
